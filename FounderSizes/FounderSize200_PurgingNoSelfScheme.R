#Repeat Simulation in April, 2019 for StandardScheme=NoSelf200FounderSize
library(rrBLUP)
library(snowfall)
...
outputResults(summarize=FALSE, saveDataFileName=paste(baseName, "FounderSize200_NoSelfAllOut", sep=""))
pdf(paste(baseName, "FounderSize200_NoSelfPlot.pdf", sep=""))
plotData(addDataFileName=paste(baseName, "FounderSize200_NoSelfPlotOut", sep=""), popID=list(0:1, c(4:5,13,19), c(8:9,18), c(12,14), c(17,20), 23))
dev.off()
