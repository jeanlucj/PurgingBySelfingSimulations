#Repeat Simulation in April, 2019 for StandardScheme=Self1500FounderSize
library(rrBLUP)
library(snowfall)
...
outputResults(summarize=FALSE, saveDataFileName=paste(baseName, "FounderSize1500_SelfAllOut", sep=""))
pdf(paste(baseName, "FounderSize1500_SelfPlot.pdf", sep=""))
plotData(addDataFileName=paste(baseName, "FounderSize1500_SelfPlotOut", sep=""), popID=list(0:1, c(4:5,13,19), c(8:9,18), c(12,14), c(17,20), 23))
dev.off()
