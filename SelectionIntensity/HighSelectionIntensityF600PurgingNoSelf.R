#Repeat Simulation in April, 2019 for HighSelectionIntensity=NoSelf
library(rrBLUP)
library(snowfall)
...
outputResults(summarize=FALSE, saveDataFileName=paste(baseName, "HighSelectionIntensityF600_NoSelfAllOut", sep=""))
pdf(paste(baseName, "HighSelectionIntensityF600_NoSelfPlot.pdf", sep=""))
plotData(addDataFileName=paste(baseName, "HighSelectionIntensityF600_NoSelfPlotOut", sep=""), popID=list(0:1, c(4:5,13,19), c(8:9,18), c(12,14), c(17,20), 23))
dev.off()
