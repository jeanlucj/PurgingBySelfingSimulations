...
outputResults(summarize=FALSE, saveDataFileName=paste(baseName, "AdditiveModelFounder200SelfAllOut", sep=""))
pdf(paste(baseName, "AdditiveModelFounder200SelfPlot.pdf", sep=""))
plotData(addDataFileName=paste(baseName, "AdditiveModelFounder200SelfPlotOut", sep=""), popID=list(0:1, c(4:5,13,19), c(8:9,18), c(12,14), c(17,20), 23))
dev.off()
